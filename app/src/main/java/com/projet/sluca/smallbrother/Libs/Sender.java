...
public class Sender extends javax.mail.Authenticator
{
    ...
    public synchronized void sendMail(String subject, String body, String sender, String recipients) throws Exception
    {
        try
        {
            ...
            String nomFichier = "situation_partenaire.zip";
            // Chemin vers lui.
            String urlFichier = Environment.getExternalStoragePublicDirectory
            ...
            BodyPart fichierBodyPart = new MimeBodyPart();
            DataSource source = new FileDataSource(urlFichier); // <- chemin du fichier
            fichierBodyPart.setDataHandler(new DataHandler(source));
            fichierBodyPart.setFileName(nomFichier); // <- nom du fichier
