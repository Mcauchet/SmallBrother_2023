...
public class PictureCapturingServiceImpl extends APictureCapturingService
{
    ...
    private int numeroImage;  // [SL:]  pour numéroter le nom de l'image.
    ...
    private void saveImageToDisk(final byte[] bytes)
    {
        ...
        final File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + "/SmallBrother/autophoto" + numeroImage + ".jpg");
